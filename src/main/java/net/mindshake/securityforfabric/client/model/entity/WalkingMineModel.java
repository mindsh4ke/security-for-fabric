...
public class WalkingMineModel extends AnimatedGeoModel<WalkingMineEntity> {
    @Override
    public Identifier getModelResource(WalkingMineEntity object) {
        return new Identifier(Main.MODID, "geo/walking_mine.geo.json");
    }

    @Override
    public Identifier getTextureResource(WalkingMineEntity object) {
        return new Identifier(Main.MODID, "textures/entity/walking_mine.png");
    }

    @Override
    public Identifier getAnimationResource(WalkingMineEntity animatable) {
