...
public class WalkingMineSpawner extends Item {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        if (Screen.hasShiftDown()) {
            tooltip.add(MutableText.of(new TranslatableTextContent("tooltip.securityforfabric.walking_mine_item_0")));
            tooltip.add(MutableText.of(new TranslatableTextContent("tooltip.securityforfabric.walking_mine_item_1")));
        } else {
