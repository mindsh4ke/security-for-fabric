...
public class SmartChestBlock extends BlockWithEntity {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (player.isSneaking() && isOwner) {
            ...
            player.sendMessage(new TranslatableText("message.securityforfabric.cannot_use"), true);
        }
    ...
    public void onPlaced(World world, BlockPos pos, BlockState state, LivingEntity placer, ItemStack itemStack) {
        ...
        ((SmartChestBlockEntity)world.getBlockEntity(pos)).setOwnerName(player.getDisplayName().asString());
    }
