...
public class SensorBlock extends BlockWithEntity {
    ...
    public void appendTooltip(ItemStack stack, @Nullable BlockView world, List<Text> tooltip, TooltipContext options) {
        if (Screen.hasShiftDown()) {
            tooltip.add(MutableText.of(new TranslatableTextContent("tooltip.securityforfabric.sensor_0")));
            tooltip.add(MutableText.of(new TranslatableTextContent("tooltip.securityforfabric.sensor_1")));
        } else {
